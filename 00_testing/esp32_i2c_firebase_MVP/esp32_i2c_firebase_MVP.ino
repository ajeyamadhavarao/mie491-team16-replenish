...
*/
  ...
  if (Firebase.RTDB.getInt(&fbdo, "/pump/vol/intValue4")) {
    if (fbdo.dataType() == "int") {
...
void resetPumpSelection() {
  if (Firebase.RTDB.setInt(&fbdo, "pump/left/intValue1", 0) && Firebase.RTDB.setInt(&fbdo, "pump/middle/intValue2", 0) && Firebase.RTDB.setInt(&fbdo, "pump/right/intValue3", 0)) {
...
void resetVolSelection() {
  if (Firebase.RTDB.setInt(&fbdo, "pump/vol/intValue4", 0)) {
